...
exports.getAllProfile = (id, limit, search, offset, sortBy, cb) => {
  db.query(`SELECT * FROM profile WHERE user_id != $2 AND fullname LIKE '%${search}%' ORDER BY fullname ${sortBy} LIMIT $1 OFFSET ${offset}`, [limit, id], (err, res) => {
